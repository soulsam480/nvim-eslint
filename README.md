...
-   `validate`: same as `eslint.validate` option in `vscode-eslint` [settings options](https://github.com/microsoft/vscode-eslint?tab=readme-ov-file#settings-options)

-   `packageManager`: already deprecated by `vscode-eslint`, so I comment it out

-   `useESLintClass`: same as `eslint.useESLintClass` option in `vscode-eslint` [settings options](https://github.com/microsoft/vscode-eslint?tab=readme-ov-file#settings-options)

-   `useFlatConfig`: it can be either a function or a boolean value that has the same meaning of `eslint.useFlatConfig` option in `vscode-eslint` [settings options](https://github.com/microsoft/vscode-eslint?tab=readme-ov-file#settings-options)
...
-   `codeAction`: same as `eslint.codeAction` option in `vscode-eslint` [settings options](https://github.com/microsoft/vscode-eslint?tab=readme-ov-file#settings-options)
-   `codeActionOnSave`: same as `eslint.codeActionOnSave` option in `vscode-eslint` [settings options](https://github.com/microsoft/vscode-eslint?tab=readme-ov-file#settings-options)
-   `format`: same as `eslint.format` option in `vscode-eslint` [settings options](https://github.com/microsoft/vscode-eslint?tab=readme-ov-file#settings-options)
-   `quiet`: same as `eslint.quiet` option in `vscode-eslint` [settings options](https://github.com/microsoft/vscode-eslint?tab=readme-ov-file#settings-options)
-   `onIgnoredFiles`: same as `eslint.onIgnoredFiles` option in `vscode-eslint` [settings options](https://github.com/microsoft/vscode-eslint?tab=readme-ov-file#settings-options)
-   `options`: same as `eslint.options` option in `vscode-eslint` [settings options](https://github.com/microsoft/vscode-eslint?tab=readme-ov-file#settings-options)
-   `rulesCustomizations`: same as `eslint.rules.customizations` option in `vscode-eslint` [settings options](https://github.com/microsoft/vscode-eslint?tab=readme-ov-file#settings-options)
-   `run`: same as `eslint.run` option in `vscode-eslint` [settings options](https://github.com/microsoft/vscode-eslint?tab=readme-ov-file#settings-options)
-   `problems`: same as `eslint.problems` in `vscode-eslint` [settings options](https://github.com/microsoft/vscode-eslint?tab=readme-ov-file#settings-options)
