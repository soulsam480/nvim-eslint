...
function M.resolve_bun_path()
	local is_windows = vim.loop.os_uname().sysname == "Windows_NT"
	local command = is_windows and "where.exe bun" or "which bun"
...
function M.create_cmd()
	...
	return { "bun", M.get_plugin_root() .. "/vscode-eslint/server/out/eslintServer.js", "--stdio" }
end
